    ...
    return PopScope(
        ...
        child: Scaffold(
          ...
          bottomNavigationBar: Obx(() {
            ...
            final bottomBarTheme = controller.selectedTabIndex.value == 0
                ? ThemeData.dark()
                : Theme.of(context);
            return Theme(
              data: bottomBarTheme,
              child: BottomNavigationBar(
                ...
                selectedItemColor: bottomBarTheme.brightness == Brightness.dark
                    ? Colors.white
                    : Colors.black,
                ...
                items: [
                  ...
                  BottomNavigationBarItem(
                    icon: bottomBarTheme.brightness == Brightness.dark
                        ? SvgPicture.asset(
                            'assets/icons/create_button_dark.svg',
                          )
                        : SvgPicture.asset(
                            'assets/icons/create_button_light.svg',
                          ),
                    label: 'Create',
                  ),
                  BottomNavigationBarItem(
